	<div class="container">
		<div class="columns">
			<div class="column">
				<h1 class="is-size-1">Print table</h1>
			</div>
		</div>
		<div class="columns">
			<div class="column">
				...
				<div class="field">
					<label class="label">Fill character</label>
					<div class="control">
						<input id="relleno" value=" " class="input" type="text" maxlength="1"
							placeholder="Cell fill char">
					</div>
				</div>
				<div class="field">
					<label class="label">Max name length</label>
					<div class="control">
						<input id="maximaLongitudNombre" value="19" class="input" type="number">
					</div>
				</div>
				<div class="field">
					<label class="label">Max quantity length</label>
					<div class="control">
						<input id="maximaLongitudCantidad" value="5" class="input" type="number">
					</div>
				</div>
				<div class="field">
					<label class="label">Max price length</label>
					<div class="control">
