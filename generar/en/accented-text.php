...
<div class="container">
    <div class="columns">
        <div class="column">
            <h1 class="is-size-1">Accented text</h1>
        </div>
    </div>
    <div class="columns">
        <div class="column">
            ...
            <br>
            <button id="btnImprimir" class="button is-success mt-2">Print without changing charcode page</button>
            <button id="btnImprimirSegunPaginaDeCodigos" class="button is-info mt-2">Print by using charcode page</button>
            <button id="btnImprimirTicket" class="button is-warning mt-2">Print ticket with diacritic text</button>
        </div>
        <div class="column">
            <div class="notification is-warning">
                <p>
                When printing, the result receipt should look like this:
                </p>
            </div>
